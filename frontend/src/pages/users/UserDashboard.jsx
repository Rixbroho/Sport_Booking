...
const UserDashboard = ({ user = { username: "Guest", role: "Player" }, onLogout, setCurrentPage }) => {
  ...
  const stats = [
    ...
    { label: 'Favorite Turf', value: 'Arena 5', icon: MapPin, color: 'text-blue-600', bg: 'bg-blue-100' },
    { label: 'Hours Played', value: '24h', icon: Clock, color: 'text-orange-600', bg: 'bg-orange-100' },
    { label: 'Points', value: '850', icon: Trophy, color: 'text-purple-600', bg: 'bg-purple-100' },
  ];

  const upcomingBookings = [
    { id: 'BK-9921', turf: 'Champions Arena', date: 'Oct 24, 2023', time: '18:00', status: 'Confirmed', price: '$45' },
    { id: 'BK-9925', turf: 'Green Valley Turf', date: 'Oct 28, 2023', time: '20:00', status: 'Pending', price: '$50' },
  ];
                    ...
                    {upcomingBookings.map((booking) => (
                      <tr key={booking.id} className="hover:bg-gray-50 transition-colors">
                        <td className="px-6 py-4">
                          <div className="font-bold text-gray-800">{booking.turf}</div>
                          <div className="text-xs font-mono text-gray-400">{booking.id}</div>
                        </td>
                        <td className="px-6 py-4">
                        ...
                        <td className="px-6 py-4 font-bold text-gray-800">{booking.price}</td>
                      </tr>
                    ))}
                  </tbody>
                </table>
