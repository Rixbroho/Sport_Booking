    ...
    <div className="min-h-screen bg-gradient-to-br from-emerald-400 via-green-500 to-teal-600 flex items-center justify-center p-4">
      <div className="bg-white rounded-3xl shadow-2xl w-full max-w-md overflow-hidden">
        <div className="bg-gradient-to-br from-emerald-500 to-green-600 p-8 text-white text-center">
          ...
          <p className="text-emerald-50">Set a new password for <span className="font-semibold">{email}</span></p>
        </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  required
                  className="w-full pl-4 pr-12 py-3 border-2 border-gray-200 rounded-xl focus:ring-2 focus:ring-emerald-500 outline-none"
              ...
              <div className="mt-2 flex items-center gap-2">
                <div className={`h-2 flex-1 rounded ${strength === 0 ? 'bg-gray-200' : strength === 1 ? 'bg-red-400' : strength === 2 ? 'bg-yellow-400' : strength === 3 ? 'bg-emerald-400' : 'bg-green-600'}`} style={{width: `${(strength/4)*100}%`}} />
                <div className="text-xs text-gray-600">{strength <= 1 ? 'Weak' : strength === 2 ? 'Fair' : strength === 3 ? 'Good' : 'Strong'}</div>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                />
                <button type="button" onClick={() => setShowConfirm(!showConfirm)} className="absolute right-3 top-3 text-sm text-gray-600">
